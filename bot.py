...
def button(update: Update, context: CallbackContext) -> None:
    ...
    if query.data == 'register':
        ...
        query.edit_message_text(
            text="Список курсов и вебинаров Tillo:\n1. 30.09 - Черепанова Екатерина: 5 ошибок, из-за которых здоровое питание не становится образом жизни\n2. 19.10 - Галеева Ирина: Упадок сил, выгорание или гормональный сбой? Как понять, что происходит с организмом\n3. 30.10 - Крумкач Ольга: Гормоны и энергия или женское здоровье без мифов"
        )
